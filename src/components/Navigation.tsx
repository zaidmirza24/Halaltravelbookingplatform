      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <a href="#destinations" className="text-neutral-700 hover:text-emerald-600 transition-colors">Destinations</a>
            <a href="#packages" className="text-neutral-700 hover:text-emerald-600 transition-colors">Packages</a>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-t">
          <div className="container-custom py-4 flex flex-col gap-4">
            <a href="#destinations" className="text-neutral-700 py-2">Destinations</a>
            <a href="#packages" className="text-neutral-700 py-2">Packages</a>
            ...
            <div className="flex items-center gap-4 pt-4 border-t">
              ...
              <Button variant="primary" size="small" className="flex-1">Sign Up</Button>
            </div>
          </div>
        </div>
      )}
